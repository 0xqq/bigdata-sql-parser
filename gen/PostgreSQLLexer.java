...
public class PostgreSQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DETERMINISTIC", "DIAGNOSTICS", "DICTIONARY", "DISABLE_P", "DISABLE_PAGE_SKIPPING", 
			...
			"MINITCOND", "SORTOP", "PARALLEL", "HYPOTHETICAL", "SAFE", "UNSAFE", 
			"BASETYPE", "IF", "LOCALE", "LC_COLLATE", "LC_CTYPE", "PROVIDER", "VERSION", 
			"ALLOW_CONNECTIONS", "IS_TEMPLATE", "EVENT", "WRAPPER", "SERVER", "BTREE", 
			"HASH_", "GIST", "SPGIST", "GIN", "BRIN", "CONCURRENTLY", "INLINE", "MATERIALIZED", 
			"LEFTARG", "RIGHTARG", "COMMUTATOR", "NEGATOR", "HASHES", "MERGES", "FAMILY", 
			"POLICY", "OWNED", "ABSTIME", "BIGSERIAL", "BIT_VARYING", "BOOL", "BOX", 
			"BYTEA", "CHARACTER_VARYING", "CIDR", "CIRCLE", "FLOAT4", "FLOAT8", "INET", 
			"INT2", "INT4", "INT8", "JSON", "JSONB", "LINE", "LSEG", "MACADDR", "MACADDR8", 
